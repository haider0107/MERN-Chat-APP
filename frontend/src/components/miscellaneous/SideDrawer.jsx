...
function SideDrawer() {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      toast({
        title: "Error Occured!",
        description: "Faailed to load the Search Results",
        status: "error",
        duration: 5000,
        isClosable: true,
  ...
  const accessChat = async (userId) => {
    try {
      ...
      // If _id is not found in the chats then set chat to previous state and add new chat object...
